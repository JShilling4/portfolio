        ...
        projects: [
            {
                ...
                type: "webapp",
                isActive: true,
                description: "Side project web app that takes a domain or IP address and returns information about the IP address. I used Svelte for the JS and Sass for styles.",
                desktopImage: {
            ...
            },
            {
                ...
                type: "webapp",
                isActive: true,
                description: "I built this web app for Ruoff Mortgage when a reactive mortgage calculator was needed for ruoff.com. I used Vue for the JS and Sass for styles.",
                desktopImage: {
